...
export default function AllPerks() {
  ...
  useEffect(() => {
    // Load all perks when page first mounts
    loadAllPerks()
  }, [])

  // ==================== useEffect #2: Auto-search on Input/Filter Change ====================
  useEffect(() => {
    // Add debounce for smoother auto-search
    const delay = setTimeout(() => {
      loadAllPerks()
    }, 500) // wait 500ms after user stops typing

    return () => clearTimeout(delay)
  }, [searchQuery, merchantFilter]) // re-run whenever user changes input or filter

  // ==================== useEffect #3: Extract Unique Merchants ====================
  useEffect(() => {
